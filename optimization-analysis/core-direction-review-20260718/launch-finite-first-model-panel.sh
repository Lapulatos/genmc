...
definition="$source_root/optimization-analysis/core-direction-review-20260718/finite-first-model-panel.xml"
out="${1:?pass a new first-model result directory}"

[[ "$out" == "$root/formal-results/finite-first-model-panel-"* && ! -e "$out" ]] || exit 2
