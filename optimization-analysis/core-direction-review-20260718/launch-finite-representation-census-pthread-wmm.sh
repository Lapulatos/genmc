...
out="${1:?pass a new finite-representation result directory}"

[[ "$out" == "$root/formal-results/finite-representation-pthread-wmm-"* && ! -e "$out" ]] || exit 2
