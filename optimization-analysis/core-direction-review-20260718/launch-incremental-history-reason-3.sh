...
definition="$source_root/optimization-analysis/core-direction-review-20260718/incremental-history-reason-3.xml"
...
[[ "$out" == "$root/formal-results/incremental-history-reason-3-"* && ! -e "$out" ]] || exit 2
...
export GENMC_REWRITE_ROOT="/workspace/experiments/caat-optimization/incremental-history-reason-rewrite/$(basename "$out")"
