...
- Tasks: 725 per variant; total rows: 1,450; semantic/search mismatches: 149.
- Status counts: V9 `{'true': 288, 'false(unreach-call)': 112, 'TIMEOUT': 276, 'OUT OF MEMORY': 22, 'ERROR (17)': 1, 'ERROR (compilation)': 13, 'ERROR (unsupported property: invalid memory access)': 7, 'ERROR (unsupported external)': 2, 'ABORTED': 2, 'SEGMENTATION FAULT': 1, 'ERROR (unsupported property: uninitialized memory)': 1}`; V10 `{'true': 289, 'false(unreach-call)': 107, 'TIMEOUT': 280, 'OUT OF MEMORY': 22, 'ERROR (compilation)': 13, 'ERROR (unsupported property: invalid memory access)': 7, 'ERROR (unsupported external)': 2, 'ABORTED': 2, 'SEGMENTATION FAULT': 1, 'TIMEOUT (false(unreach-call))': 1, 'ERROR (unsupported property: uninitialized memory)': 1}`.
...
- CPU V10/V9: 1.056648 [1.032744, 1.083892].
- Wall V10/V9: 1.056562 [1.032461, 1.083412].
- RSS V10/V9: 1.000224 [0.999908, 1.000590].
