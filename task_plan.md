...
- [ ] Implementation 2: Offline CAAT backend（Phase 2.0--2.1 完成；2.2--2.6 待实现）
...
**Current target: Phase 2.2** - 为 normalized IR 实现 signed dependency、Tarjan SCC、stratification、semi-positivity 与 domain-independence 分析。
