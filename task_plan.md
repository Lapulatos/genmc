...
- [ ] Implementation 2: Offline CAAT backend（Phase 2.0 规划完成；2.1--2.6 待实现）
...
**Current target: Phase 2.1** - 按 `doc/cat/phase-2-plan.md` 实现递归 CAT 前端与规范化 typed IR；每个子阶段验证、差距分析、commit 并 push 后再进入下一项。
